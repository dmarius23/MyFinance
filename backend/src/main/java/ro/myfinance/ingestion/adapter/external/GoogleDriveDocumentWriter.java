...
public class GoogleDriveDocumentWriter implements DriveDocumentWriter {
    ...
    public String put(String sharedDriveId, String rootFolderId, List<String> folderSegments,
        ...
        for (String segment : folderSegments) {
            parent = ensureFolder(token, sharedDriveId, parent, segment);
        }
        return createFile(token, sharedDriveId, parent, name, contentType, bytes, documentId);
    }
    ...
    private String ensureFolder(String token, String sharedDriveId, String parentId, String name) {
        ...
        JsonNode found = getJson(http.get()
                .uri(b -> b.scheme("https").host("www.googleapis.com").path("/drive/v3/files")
                        ...
                        .queryParam("driveId", sharedDriveId)
                        .build())
    ...
    private String createFile(String token, String sharedDriveId, String parentId, String name,
