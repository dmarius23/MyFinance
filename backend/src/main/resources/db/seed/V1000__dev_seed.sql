...
VALUES
  ...
  ('00000000-0000-0000-0000-0000000000c2', '00000000-0000-0000-0000-000000000001', 'Client Doi SRL', 'SRL', 'RO44445555', 'Bucuresti',    'NON_PAYER', 'QUARTERLY', '00000000-0000-0000-0000-0000000000a2', 'ACTIVE')
ON CONFLICT (id) DO NOTHING;
