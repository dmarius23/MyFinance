...
const resources = {
  ro: {
    translation: {
      ...
      "email.body": "Bună ziua,\nMai avem nevoie de extras de cont / facturi / chitanțe pentru luna selectată. Vă rugăm să le încărcați în portal.\nMulțumim,\nContaZone SRL",
  ...
  en: {
    translation: {
      ...
      "email.body": "Hello,\nWe still need the bank statement / invoices / receipts for the selected month. Please upload them in the portal.\nThank you,\nContaZone SRL",
